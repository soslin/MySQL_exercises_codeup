...
-- 2. Use DISTINCT to find the unique titles table.
 SELECT DISTINCT title 
	FROM titles;
 
 
 -- 3. Find your query for employees whose last names start and end with 'E'. Update the query find just the unique last 
--  names that start and end with 'E' using GROUP BY.
 ...
 -- 4. Update your previous query to now find unique combinations of first and last name where the last name 
...
-- 6. Add a COUNT() to your results and use ORDER BY to make it easier to find employess whose unusual name is shared with others.
 ...
 -- 7. Update your query for 'Irena', 'Vidya' or 'Maya'. Use COUNT(*) and GROUP BY to find the number of 
